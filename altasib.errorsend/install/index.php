...
Class altasib_errorsend extends CModule
{
        ...
        function altasib_errorsend()
        {
                ...
                {
                        $this->MODULE_VERSION = "1.6.1";
                        $this->MODULE_VERSION_DATE = "2018-10-18 23:47:00";
                }
        ...
        function InstallDB()
        {
                ...
                if(CModule::IncludeModule("iblock"))
                {
                        ...
                        COption::SetOptionString("altasib_errorsend", "ERROR_SEND_IBLOCK_BASE_CODE", GetMessage("ALTASIB_ERROR_SEND_IBLOCK_TYPE_NAME_EN"));
                        ...
                        {
                                $iblockCode = GetMessage("ALTASIB_ERROR_SEND_IBLOCK_TYPE_NAME_EN").'_'.$arSite['LID'];
                                $arIB = CIBlock::GetList(false,Array("CODE"=>$iblockCode))->Fetch();
                                if(!$arIB)
                                {
                                        $ib = new CIBlock;
                                        $arFields = Array(
                                                "NAME" => GetMessage("ALTASIB_ERROR_SEND_IBLOCK_TYPE_NAME")." [".$arSite["LID"]."] ".$arSite["NAME"],
                                                "CODE" => $iblockCode,
                                                "LIST_PAGE_URL" =>"",
                                                "DETAIL_PAGE_URL" =>"",
